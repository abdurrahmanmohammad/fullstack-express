...
exports.compilePom = compilePom;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const constants_1 = require("../../constants");
function compilePom(setupConfig) {
    const pomTemplatePath = path.join(constants_1.TEMPLATE_DIR, 'pom.xml');
    ...
    const pomOutputPath = path.join(constants_1.OUTPUT_DIR, 'pom.xml');
    fs.writeFileSync(pomOutputPath, pomTemplate, 'utf8');
    console.log(`Generated: ${pomOutputPath}`);
}
//# sourceMappingURL=pom_compiler.js.map